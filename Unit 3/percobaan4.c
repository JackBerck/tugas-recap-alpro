...
// Selanjutnya, program mencetak header tabel menggunakan `printf` pada dua printf pertama, kemudian melakukan iterasi melalui array nama dan usia menggunakan loop `for`. Dalam setiap iterasi, program mencetak nama dan usia orang yang sesuai dengan indeks yang sedang diiterasi